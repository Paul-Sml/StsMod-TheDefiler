...
public class NextTurnPowerPower extends AbstractEasyPower {
    private AbstractPower powerToGain;
        /*
    private static Texture arrow48 = TexLoader.getTexture("thedefilermodResources/images/ui/arrow48.png");
    private static Texture arrow128 = TexLoader.getTexture("thedefilermodResources/images/ui/arrow128.png");
