...
public class TheDefiler extends CustomPlayer {
    ...
    static final String ID = makeID("TheDefiler"); //TODO: Change this
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheDefiler(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new TheDefiler(name, chosenClass);
    }
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_DEFILER;
        @SpireEnum(name = "TODO_COLOR")
        public static AbstractCard.CardColor DEFILER_COLOR;
        @SpireEnum(name = "TODO_COLOR")
